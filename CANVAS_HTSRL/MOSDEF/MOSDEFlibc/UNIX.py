...
class UNIX(POSIX, ANSI, crippleC):
    ...
    def _UNIX_initLocalFunctions(self):
        ...
        self.add_generic_syscall('fcntl', 'int', 'int fd', 'int cmd', 'int arg')
        ...
        #self.add_generic_syscall('wait4', 'int', 'int wpid', 'int *status', 'int options', 'struct rusage *rusage')
