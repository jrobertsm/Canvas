...
class x86osxremoteresolver(osxremoteresolver):
    def __init__(self, proc = 'i386', version = '10.4'):
        osxremoteresolver.__init__(self, proc, version)
...
class ppcosxremoteresolver(osxremoteresolver):
    def __init__(self, proc = 'PowerPC', version = '10.4'):
        ...
        self.arch="PPC"
        self.sfunctioncache = ()
        remoteresolver.__init__(self, 'MacOSX', proc, version)
