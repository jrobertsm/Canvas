...
from libs.paramiko.config import SSHConfig
...
def inflate_long(s, always_positive=False):
    "turns a normalized byte string into a long-int (adapted from libs.Crypto.Util.number)"
    out = 0L
    negative = 0
...
def deflate_long(n, add_sign_padding=True):
    "turns a long-int into a normalized byte string (adapted from libs.Crypto.Util.number)"
