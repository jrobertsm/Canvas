...
from libs.paramiko import util
from libs.paramiko.auth_handler import AuthHandler
from libs.paramiko.channel import Channel
from libs.paramiko.common import *
from libs.paramiko.compress import ZlibCompressor, ZlibDecompressor
from libs.paramiko.dsskey import DSSKey
from libs.paramiko.kex_gex import KexGex
from libs.paramiko.kex_group1 import KexGroup1
from libs.paramiko.message import Message
from libs.paramiko.packet import Packetizer, NeedRekeyException
from libs.paramiko.primes import ModulusPack
from libs.paramiko.rsakey import RSAKey
from libs.paramiko.server import ServerInterface
from libs.paramiko.sftp_client import SFTPClient
from libs.paramiko.ssh_exception import SSHException, BadAuthenticationType, ChannelException
...
from libs.Crypto.Cipher import Blowfish, AES, DES3, RC4
from libs.Crypto.Hash import SHA, MD5
...
class Transport (threading.Thread):
    ...
    #CANVAS Crypto does not have pure-python blowfish or 3des
    _preferred_ciphers = ( 'aes128-cbc', 'aes256-cbc','arcfour')
    ...
    _cipher_info = {
        'blowfish-cbc': { 'class': Blowfish, 'mode': Blowfish.MODE_CBC, 'block-size': 8, 'key-size': 56 },
        'aes128-cbc': { 'class': AES, 'mode': AES.MODE_CBC, 'block-size': 16, 'key-size': 16 },
        'aes256-cbc': { 'class': AES, 'mode': AES.MODE_CBC, 'block-size': 16, 'key-size': 32 },
        '3des-cbc': { 'class': DES3, 'mode': DES3.MODE_CBC, 'block-size': 8, 'key-size': 24 },
        'arcfour': { 'class': RC4, 'mode': None, 'block-size': 8, 'key-size': 16 },
        }
    #'arcfour': { 'class': RC4, 'mode': None, 'block-size': 8, 'key-size': 24 },
