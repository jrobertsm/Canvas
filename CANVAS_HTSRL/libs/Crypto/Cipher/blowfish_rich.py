...
class Blowfish:
    ...
    def __init__ (self, key, big_endian=True):
        ...
        ##Set endianess - defaults to original behaviour which is Big Rich Mod
    ...
    def encrypt (self, data):
        ...
        ##What endianess do we want ?? Rich Mod
        if self.big_endian:
            chars = ''.join ([
            ...
            ##Little endian for compat with blowfish.c/blowfish.h
            chars = ''.join ([
