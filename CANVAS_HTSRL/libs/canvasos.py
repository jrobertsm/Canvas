...
class canvasos:
    ...
    def __init__(self, base=""):
        ...
        if self.base == "Windows":
            # yeah yeah, show me someone who actually uses Windows on Alpha. :p
            self.arch = "x86"
    ...
    def load_uname(self,unamestr):
        ...
        x86es = ["i386", "i486", "i686","i586","i86pc", "amd64"]
        ...
        if unamestr.count("[Version"):
            ...
            if x[0] == "Windows":
                ...
                elif x[0] == "NetWare": # Hey, you think I'm crazy? Seriously. Netware.
                    self.arch = "x86"
                    self.base = x[0]
    ...
    def isUnix(self):
        ...
        if self.cygwin:
            return True 
        Unixes=["Linux","BSD","OS X","Solaris", "FreeBSD", "OpenBSD", "Unix"]
        for u in Unixes:
            if u==self.base:
                return True
        return False
...
def fromModule(mod):
    ...
    ARCH: OS major class, eg Windows, Solaris, Mac OSX, Supposed to be a list of lists, where each element is ["OS", "Version", "Version" ...]
