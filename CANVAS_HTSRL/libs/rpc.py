...
class Unpacker(xdr.Unpacker):
        def __init__(self,data):
                xdr.Unpacker.__init__(self,data)
...
class Client:
        ...
        def __init__(self, host, prog, vers, port, getsock=None, covertness=1):
                self.host = host
                self.prog = prog
                self.vers = vers
                self.port = port
        ...
        def start_call(self, proc):
                ...
                p = self.packer
                p.reset()
                #print "About to call callheader"
                p.pack_callheader(xid, self.prog, self.vers, proc, cred, verf)
                #print "len of p=%d"%len(p.buf)
...
class RawTCPClient(Client):
        def makesocket(self,getsock=None):
                if getsock: #we have a remote socket object instantiation capability
                        self.sock=getsock.gettcpsock()
                else:
        ...
        def do_call(self):
                ...
                if self.covertness>=9:
                        ...
                        i=0
                        for c in call:
                                sendfrag(self.sock,0,c)
                                time.sleep(1.5)
                                i+=1
                                        
                        sendfrag(self.sock,1,"")
                else:
...
class PortMapperUnpacker(Unpacker):
        def __init__(self,data):
                Unpacker.__init__(self,data)
                
        def unpack_mapping(self):
                #print "unpack mapping called"
                prog = self.unpack_uint()
                vers = self.unpack_uint()
...
class TCPPortMapperClient(PartialPortMapperClient, RawTCPClient):
        ...
        def __init__(self, host,getsock=None):
                RawTCPClient.__init__(self, host, PMAP_PROG, PMAP_VERS, PMAP_PORT,getsock=getsock)
...
class TCPClient(RawTCPClient):
        ...
        def __init__(self, host, prog, vers,port=0,getsock=None):
                if port == 0:
                        pmap = TCPPortMapperClient(host,getsock=getsock)
...
class UDPClient(RawUDPClient):
        ...
        def __init__(self, host, prog, vers,getsock=None):
