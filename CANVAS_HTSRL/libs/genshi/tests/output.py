...
from libs.genshi.core import Attrs, Stream, QName
from libs.genshi.input import HTML, XML
from libs.genshi.output import DocType, XMLSerializer, XHTMLSerializer, \
