...
from libs.genshi.input import ET, HTML, XML
from libs.genshi.output import DocType
from libs.genshi.template.base import Template
from libs.genshi.template.loader import TemplateLoader
