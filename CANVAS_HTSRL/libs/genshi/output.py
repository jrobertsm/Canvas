...
from libs.genshi.core import escape, Attrs, Markup, Namespace, QName, StreamEventKind
from libs.genshi.core import START, END, TEXT, XML_DECL, DOCTYPE, START_NS, END_NS, \
...
class NamespaceFlattener(object):
    ...
    >>> from libs.genshi.input import XML
