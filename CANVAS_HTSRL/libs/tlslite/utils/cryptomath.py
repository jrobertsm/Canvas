...
try:
    #Canvas includes a libs/Crypto/Cipher/AES.py which is
    #not the same as the real pycrypto versions (We only use
    #pure-Python code). So this is the ARC4 check, which
    #will break if we ever define that file
