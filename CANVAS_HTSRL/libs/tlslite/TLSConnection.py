...
class TLSConnection(TLSRecordLayer):
    ...
    def handshakeClientCert(self, certChain=None, privateKey=None,
                            ...
                            async=False, max_timeout_count=10):
        ...
        timeout_count=0
        for result in handshaker:
            devlog("tlslite", "Result: %r"%result)
            if result==0 and timeout_count==max_timeout_count:
                #timeout has reached its limit
                raise TLSError, "Timeout on handshake reached max timeout count"
            timeout_count+=1
            pass
