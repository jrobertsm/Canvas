...
class basecode:
    def __init__(self, restorehash = False, VirtualProtect = False):
        self.functions = ''
        self.main = ''
    ...
    def find_function(self, dll_function):
        ...
        self._functions.append(dll_function)
    ...
    def _set_functions(self):
        ...
        nextinlist:
            movl (%ecx),%edx      // Pointer to next loadeded DLL
...
#        else:
    ...
    def find_kernel32(self):
        """ find kernel32.dll """

        # using PEB @ fs:0x30(0) method
        self._globals.addDword('KERNEL32')
        
        if 'find_kernel32:' not in self.functions:
            self.functions += """
        // we want this to be callable .. NT only
        find_kernel32:
            xorl %eax,%eax
            movl fs:0x30(%eax),%eax
            movl 0xc(%eax),%eax
            movl 0x1c(%eax),%eax
            movl (%eax),%eax
            movl 0x8(%eax),%eax
        ...
        find_kernel32_call:
            ...
            movl %eax,%ebx
            call getpcloc
            movl %ebx,KERNEL32-getpcloc(%ebp)
        """
        return
