...
Three different libcs, one for each mode. lcall is default, at boot, system picks which to used based on cpuid. The optimised ones are then loop mounted over the top of the real one.
