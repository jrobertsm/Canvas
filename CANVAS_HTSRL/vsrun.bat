@ECHO OFF
echo This is a little CANVAS VisualSploit loader. It tries Python 2.4 and 2.5
echo Copyright Immunity, Inc.

PATH=c:\GTK\bin;c:\Python24\DLLs;c:\Program Files\Common Files\GTK\2.0\lib;c:\Python24\;c:\Python25\;c:\Python25\DLLs; %PATH%
